...
const WelcomeWawride = () => {
 return (
  <>
   <div class="welcomewawride-container">
    <div class="welcomewawride-main">
     <div class="welcomewawride mt-5">
      <div class="welcomewawride-section1">
       <div class="">
        <h2>WELCOME </h2>
        <h1>WAWRides</h1>
      ...
      <div class="welcomewawride-section2">
       <div class="">
        <div class="row m-0">
         <div class="col-md-4">
          <h5>The Brand </h5>
      ...
      <div class="welcomewawride-section3">
       <div class="">
        <div class="row m-0">
         <div class="col-md-5">
          <h5>Our</h5>
      ...
      <div class="welcomewawride-section4">
       <div class="">
        <h5>Offered</h5>
        <h1>BRANDS</h1>
        <div class="">
      ...
      <div class="welcomewawride-section5">
       <div class="">
        <h5>Team</h5>
        <h1>INCREDIBLE</h1>
       </div>
      ...
      <div class="welcomewawride-section6">
       <div class="">
        <div class="row m-0">
         <div class="col-md-4">
          <div class="">
